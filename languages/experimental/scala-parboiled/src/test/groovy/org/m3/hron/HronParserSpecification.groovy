...
class HronParserSpecification  extends Specification  {
  ...
  @Unroll
  def "should return #expected from expression '#expression' using parseText for file #file"() {
    given:
  ...
  @Unroll
  def "should return #expected from expression '#expression' using parseFile for file #file"() {
    given:
