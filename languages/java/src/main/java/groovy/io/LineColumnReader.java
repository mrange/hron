 ...
 *
 * NOTE: Class copied from the groovy-core source to remove dependency on all of groovy.
 * No changes have been made to this source and all rights for this class remain with
 * the groovy source. This project is just a reference parser for the HRON data format.
 * Perhaps in some distant future this parser could be part of or an extension of the
 * groovy language.
